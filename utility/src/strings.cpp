...
#include "utility/strings/ascii.hpp"
...
bool Strings::end_with(const std::string& str, const std::string& match)
{
    return str.size() >= match.size()
           && str.rfind(match) + match.size() == str.size();
}

bool Strings::begin_with(const std::string& str, const std::string& match)
{
    return str.size() >= match.size()
...
void Strings::split(const std::string& str, const std::string& delim,
...
std::string Strings::join(const std::vector<std::string>& components,
...
std::string Strings::replace(const std::string& str,
...
std::string Strings::replace_all(const std::string& str,
                                     const std::string& oldsub, const std::string& newsub)
{
    if (oldsub.empty()) return str;
    std::string res;
...
std::string Strings::uint64_to_string(uint64_t value)
{
    char buf[32];
...
////////////// xml_escape ///////////////////////////////
void Strings::xml_escape_string(std::ostream& os, const char* src, int src_len)
{
...
std::string Strings::xml_escape_string(const char* src, int src_len)
{
    std::stringstream os;
...
////////////// json_escape ///////////////////////////////
void Strings::json_escape_string(std::ostream& os, const char* src, int src_len)
{
    for (int i = 0; i < src_len; ++i) {
        char c = *(src + i);
        switch (c)
...
std::string Strings::json_escape_string(const char* src, int src_len)
{
    std::stringstream os;
...
void Strings::encode_url(std::ostream& os, const std::string& str, int flag)
{
    size_t len = str.size();
...
std::string Strings::encode_url(const std::string& str, int flag)
{
    std::stringstream os;
...
void Strings::decode_url(std::ostream& os, const std::string& str, int flag)
{
...
std::string Strings::decode_url(const std::string& str, int flag)
{
    std::stringstream os;
